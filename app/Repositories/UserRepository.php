    ...
    */
    public function createTeacher($request) {
        try {
            ...
            throw new \Exception('Ошибка при создание учителя. '.$e->getMessage());
        }
    }
    ...
    */
    public function createStudent($request) {
        try {
            ...
            throw new \Exception('Ошибка при создание студента. '.$e->getMessage());
        }
    }
    ...
    public function updateStudent($request) {
        try {
            ...
            throw new \Exception('Ошибка при обновление студента. '.$e->getMessage());
        }
    }
    ...
    public function updateTeacher($request) {
        try {
            ...
            throw new \Exception('Ошибка при обновление учителя. '.$e->getMessage());
        }
    }
    ...
    public function getAllStudents($session_id, $class_id, $section_id) {
        if($class_id == 0 || $section_id == 0) {
            ...
            if($schoolClass == null || $section == null){
                throw new \Exception('Нет класса и раздела');
            } else {
        ...
        try {
            ...
            throw new \Exception('Не удалось получить всех студентов. '.$e->getMessage());
        }
    }
    ...
    public function findStudent($id) {
        try {
            ...
            throw new \Exception('Не удалось получить студента. '.$e->getMessage());
        }
    }
    ...
    public function findTeacher($id) {
        try {
            ...
            throw new \Exception('Не удалось получить учителя. '.$e->getMessage());
        }
    }
    ...
    public function getAllTeachers() {
        try {
            ...
            throw new \Exception('Не удалось получить всех учителей. '.$e->getMessage());
        }
    }
    ...
    public function changePassword($new_password) {
        try {
            ...
            throw new \Exception('Не удалось сменить пароль. '.$e->getMessage());
        }
    }
}