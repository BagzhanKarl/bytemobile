            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-file-text"></i> Просмотреть парвило оценки
                    </h1>
                        ...
                        <table class="table mt-4">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Закончивается в</th>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{route('exam.grade.system.rule.delete')}}" role="button" class="btn btn-sm btn-primary" onclick="event.preventDefault();
                                                     document.getElementById('delete-form-{{$gradeRule->id}}').submit();"><i class="bi bi-trash2"></i> Удалить</a>
