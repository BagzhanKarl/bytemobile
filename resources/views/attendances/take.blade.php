            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-calendar2-week"></i> ПРинимать участие
                    </h1>
                    ...
                    <div class="mt-4">Текущяя дата и время: {{ date('Y-m-d H:i:s') }}</div>
                    <div class="row mt-4">
                        <div class="col-10 bg-white border p-3 shadow-sm">
                            <form action="{{route('attendances.store')}}" method="POST">
                                ...
                                <div class="mb-4">
                                    <button type="submit" class="btn btn-outline-primary"><i class="bi bi-check2"></i> Представлять на расмотрение</button>
                                </div>
                                @endif
                            </form>
                        </div>
