            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-cloud-sun"></i> Дайте окончательные оценки
                    </h1>
                    @include('session-messages')
                    <h5><i class="bi bi-diagram-2"></i> Группа {{$class_name}}, Секция #{{$section_name}}</h5>
                    <h5><i class="bi bi-compass"></i> Курсы: {{$course_name}}</h5>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Расчетные баллы</th>
                                                <th scope="col">Окончательные баллы</th>
                                        ...
                                        <tbody>
                                                @isset($students_with_marks)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea type="text" class="form-control" rows="1" name="note[{{$students_with_mark[0]->student->id}}]" placeholder="Засчитаны лучшие 2 Quizes из 3,..."></textarea></td>
                                                    </tr>
                                                    @endforeach
                                                @endisset
