            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-cloud-sun"></i> Оценки курса
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">Мой курсы</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Оценки курса</li>
                        </ol>
                    </nav>
                    ...
                    <div class="mb-4 mt-4 p-3 bg-white border shadow-sm">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">Имя экзамена</th>
                                    <th scope="col">Знаки</th>
                                </tr>
                            </thead>
                            <tbody>
